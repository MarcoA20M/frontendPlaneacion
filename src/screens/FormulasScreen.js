    // src/screens/FormulasScreen.js - VERSIÓN FINAL CON DROPDOWN QUE CIERRA CORRECTAMENTE
    ...
    export default function FormulasScreen() {
        ...
        // Estado para el toggle de materias primas - SOLO PARA LA TABLA
        ...
        // Estados para el buscador de materia prima
        ...
        // Lista de materias primas más importantes
        ...
        // 🔴 Filtrar fórmulas para la TABLA según el toggle
        ...
        // Filtrar materias primas para el buscador (siempre TODAS las disponibles)
        useEffect(() => {
            if (!mostrarFormNueva) {
            ...
            // Materias que NO están en la fórmula
                                            ...
                                            <>
                                                <div className="producto-header-simple">
                                                    ...
                                                    <div className="header-actions">
                                                        ...
                                                        {/* TOGGLE DE MATERIAS PRIMAS - SOLO PARA LA TABLA */}
                                                ...
                                                {mostrarFormNueva && (
                                                    <div className="agregar-materia-simple">
                                                        <div className="agregar-row">
                                                            {/* BUSCADOR DE MATERIA PRIMA CON DROPDOWN QUE CIERRA */}
